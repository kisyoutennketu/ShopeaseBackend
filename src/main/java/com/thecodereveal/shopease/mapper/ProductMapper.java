...
public class ProductMapper {
    ...
    public List<ProductVariantDto> mapProductVariantListToDto(List<ProductVariant> productVariants) {
        return productVariants.stream().map(this::mapProductVariantListDto).toList();
    }

    private ProductVariantDto mapProductVariantListDto(ProductVariant productVariant) {
